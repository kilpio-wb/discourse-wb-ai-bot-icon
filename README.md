...
- On screens narrower than 900px, the centered clone is hidden and the original AI bot button stays in the right-side header icon group — this avoids overlapping the logo or wrapping below the header on narrow layouts.
